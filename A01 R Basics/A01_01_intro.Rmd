...
1. 访问Aetna AppStore，下载安装[Open Source R 3.2.4](https://appstore.aetna.com/Product/Details/72475)(须装在虚拟机上)，或
1. ~~访问R官网，下载[R for windows](https://cloud.r-project.org)并解压到C盘；安装32-bit版本~~
...
### 基础组件
- [RTools](https://cran.r-project.org/bin/windows/Rtools) : 包含`gcc`, `mingw`等编译工具
- ~~[MikTex](https://miktex.org/) : 用于生成pdf文档~~
...
C:\Docs\R\R-3.3.2\bin\Rscript.exe intro.R
@pause
```
