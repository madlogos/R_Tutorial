...
![Aetna Jive Home](A02_02_io_files/figure-html/jivehome.png)
 ==> 
![Source Code](A02_02_io_files/figure-html/jivehome_sourcecode.png)

读作页面代码文本

```r
> data <- read_lines("https://aetna.jiveon.com")
> str(data)
chr [1:616] "<!DOCTYPE html><!--[if IE 8]> <html class=\"ie8\" lang=\"en\"><![endif]--><!--[if IE 9]> <html class=\"ie9\" lang=\"en\"><![end"| __truncated__ ...
```
...
- ~~另推荐爬虫包`curl`和`RCurl` (但公司电脑不支持443/80端口SSL curl)~~
