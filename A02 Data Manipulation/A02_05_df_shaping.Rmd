...
```r
> data.table(iris)[1:2, 1:2]
   Sepal.Length Sepal.Width
1:          5.1         3.5
2:          4.9         3.0
```

- 利用`on`: 筛选Sepal.Width == 3.1, Species == 'setosa'的记录
...
```r
> d <- data.table(iris)
> d[, Sepal.LWR := Sepal.Length/Sepal.Width]
> d
     Sepal.Length Sepal.Width Petal.Length Petal.Width   Species Sepal.LWR
  1:          4.3         3.0          1.1         0.1    setosa  1.433333
  2:          4.4         3.2          1.3         0.2    setosa  1.375000
  3:          4.4         3.0          1.3         0.2    setosa  1.466667
  4:          4.4         2.9          1.4         0.2    setosa  1.517241
  5:          4.5         2.3          1.3         0.3    setosa  1.956522
 ---                                                                      
146:          7.7         3.8          6.7         2.2 virginica  2.026316
147:          7.7         3.0          6.1         2.3 virginica  2.566667
148:          7.7         2.8          6.7         2.0 virginica  2.750000
...
- 不如dplyr那样管道化，可能需要创建中间体
- 向量化计算的精神贯彻得相当彻底

```r
> d <- data.table(iris)
> d.sel <- d[Sepal.Length > 6, SPWR := Sepal.Width / Petal.Width]
> d.agg <- d.sel[, list(m = mean(SPWR, na.rm=TRUE), 
+                       sd = sd(SPWR, na.rm=TRUE)), by=Species]
> d.agg
      Species        m        sd
1:     setosa      NaN        NA
2:  virginica 1.494320 0.1874827
3: versicolor 2.044987 0.2271170
```
